 ...
 */
    ...
    SFA_CREATE			(90, OFMessage.class, new Instantiable<OFMessage>() {
        					@Override
        					public OFMessage instantiate() {
        					return new SFACreate();
        				 }}),
    SFA_ST_MOD			(91, OFMessage.class, new Instantiable<OFMessage>() {
        					@Override
        					public OFMessage instantiate() {
        					return new SFAStMod();
        				 }}),
	SFA_AT_MOD			(92, OFMessage.class, new Instantiable<OFMessage>() {
         					@Override
         					public OFMessage instantiate() {
         					return new SFAAtMod();
         				 }});
