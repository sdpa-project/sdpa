...
public enum StateFirewallStatus {
	 ...
	 * 		SFW_STATUS_REQUESTER_NONE		  		SYN	  2				SFW_STATUS_REQUESTER_SYN_SENT
	 * 		SFW_STATUS_RESPONSER_NONE				(syn) 18				SFW_STATUS_RESPONSER_ESTABLISH
	 * 		SFW_STATUS_REQUESTER_SYN_SENT			ack	   16				SFW_STATUS_REQUESTER_ESTABLISH
	 * 		SFW_STATUS_REQUESTER_ESTABLISH			FIN	   1 				SFW_STATUS_REQUESTER_FIN_SENT
	 * 		SFW_STATUS_RESPONSER_ESTABLISH			fin	  17				SFW_STATUS_RESPONSER_NONE
	 * 		SFW_STATUS_REQUESTER_FIN_SENT			ack	  17				SFW_STATUS_REQUESTER_NONE
	 *		
