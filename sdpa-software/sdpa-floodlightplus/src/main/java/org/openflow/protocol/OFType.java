...
import org.sdpa.protocol.SDPACreate;
 ...
 */
    ...
    SDPA_CREATE			(90, OFMessage.class, new Instantiable<OFMessage>() {
        					@Override
        					public OFMessage instantiate() {
        					return new SDPACreate();
        				 }}),
    SDPA_ST_MOD			(91, OFMessage.class, new Instantiable<OFMessage>() {
        					@Override
        					public OFMessage instantiate() {
        					return new SDPACreate();
        				 }}),
	SDPA_AT_MOD			(92, OFMessage.class, new Instantiable<OFMessage>() {
         					@Override
         					public OFMessage instantiate() {
         					return new SDPACreate();
         				 }});
