...
public class Firewall implements IFirewallService, IOFMessageListener,
    ...
    public void doSendSdpaInitMsg(IOFSwitch sw)
    {
    	...
    	STTDATA sttdat = new STTDATA(SDPAEventType.SDPAPARAM_IN_PORT,1,SDPAEventType.SDPAPARAM_DL_SRC,2,SDPAEventOp.OPRATOR_ISEQUAL,1,2);
    	stt_tmp.addSttData(sttdat);
    	...
    	sfc.setAT(at_tmp);
    	 ...
    	 try {
             ...
             logger.error("Failed to write {} to switch {}", new Object[]{ sfc, sw }, e);
         }
	...
	{
		//make init msg to switch
		logger.info("init procedure for st");
